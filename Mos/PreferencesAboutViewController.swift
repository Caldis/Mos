...
class PreferencesAboutViewController: NSViewController {
    ...
    override func viewDidLoad() {
        ...
        homePageButton.attributedTitle = NSAttributedString(string: homePageButton.title, attributes: [NSForegroundColorAttributeName : NSColor.white, NSParagraphStyleAttributeName : paragraphStyle])
        githubButton.attributedTitle = NSAttributedString(string: githubButton.title, attributes: [NSForegroundColorAttributeName : NSColor.white, NSParagraphStyleAttributeName : paragraphStyle])
        donateButton.attributedTitle = NSAttributedString(string: donateButton.title, attributes: [NSForegroundColorAttributeName : NSColor.white, NSParagraphStyleAttributeName : paragraphStyle])
    }
