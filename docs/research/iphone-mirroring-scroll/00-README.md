...
- **2026-07-11 ② Phase 0 完成,结论 GO**:Karabiner 代理实测,**虚拟 HID 滚轮可到达 iPhone 镜像(C2)且方向可控(C3)**——A/B 截图对照、系统自然滚动全程未动,见 `03`。路线 B 架构成立;因 CoreHID 受阻而 dext 链路已被端到端验证,**技术选型倾向 DriverKit dext**。
