...
export const uk: Translations = {
  ...
  wall: {
    ...
    errorLinks: "Посилання на стіні заборонені — приберіть його.",
    errorSpam: "Це схоже на спам, тож не опубліковано.",
    noLinksHint: "Посилання заборонені — приберіть його, щоб опублікувати.",
  },
};
