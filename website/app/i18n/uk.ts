...
export const uk: Translations = {
  ...
  sectionFeel: {
    ...
    cards: {
      ...
      buttons: {
        ...
        body:
          "Прив’яжи мишу або клавіатуру до швидких дій і вибудуй робочий процес як завгодно.",
  ...
  scroll: {
    ...
    lead:
      "Звичайне колесо миші опитується не так часто, як трекпад, тож сторінка може лише смикатися ривками. Mos переосмислює цей ввід ретельно налаштованим алгоритмом на основі реальної фізики, перетворюючи твій намір на плавний, точний рух, і сторінка тече за твоїми пальцями.",
    withoutMos: "Без Mos",
    withMos: "З Mos",
    tagRaw: "сире",
    tagSmooth: "плавно",
